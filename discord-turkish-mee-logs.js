...
module.exports = function (bot, options) {
    const description = {
        name: "discord-turkish-mee-logs",
        filename: "discord-turkish-mee-logs.js",
        version: "1.0.0"
    }
...
// ---------------------------------------------------------------------------//
    ...
    bot.on("guildMemberAdd", member => {
        ...
        var embed = {
            ...
            author: {
                name: `Kullanıcı Katıldı : ${member.user.tag}`,
...
// ---------------------------------------------------------------------------//
    ...
    bot.on("guildMemberRemove", member => {
        ...
        var embed = {
            ...
            author: {
                name: `Kullanıcı Ayrıldı : ${member.user.tag}`,
...
// ---------------------------------------------------------------------------//
    ...
    bot.on("guildBanAdd", (banguild, banuser) => {
        ...
        var embed = {
            ...
            author: {
                name: `Kullanıcı Yasaklandı : ${banuser.tag}`,
...
// ---------------------------------------------------------------------------//
    ...
    bot.on("guildBanRemove", (banguild, banuser) => {
        ...
        var embed = {
            ...
            author: {
                name: `Kullanıcının Yasağı Kaldırıldı : ${banuser.tag}`,
    ...
    bot.on("guildMemberUpdate", (oldMember, newMember) => {
        ...
        if (oldMember.nickname !==
            ...
            var embed = {
                ...
                author: {
                    name: `Takma Ad Değişti: ${newMember.user.tag}`,
        ...
        if (options.trackroles !== false) {
            ...
            if (rolechanged) {
                ...
                var embed = {
                    ...
                    author: {
                        name: `Roller Değiştirildi: ${newMember.user.tag}`,
                        icon_url: "https://cdn.discordapp.com/emojis/435119397237948427.png"
                    },
                    fields: [{
                ...
                if (newUser.id === memberid) {
                    ...
                    if (oldUser.username !== newUser.username) {
                        ...
                        usernameChangedMsg = {
                            ...
                            author: {
                                name: `Kullanıcı Adı Değişti: ${newUser.tag}`,
                    ...
                    if (oldUser.discriminator !== newUser.discriminator) {
                        ...
                        discriminatorChangedMsg = {
                            ...
                            author: {
                                name: `Ayrımcısı Değişti: ${newUser.tag}`,
                    ...
                    if (oldUser.avatar !== newUser.avatar) {
                        ...
                        avatarChangedMsg = {
                            ...
                            author: {
                                name: `Avatar Değişti: ${newUser.tag}`,
